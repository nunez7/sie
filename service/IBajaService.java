...
public interface IBajaService {
	...
	List<Baja> buscarPorTipoStatusCarreraEntreFechas(Integer estatus, Integer idCarrera, Integer idPeriodo, Date fechaInicio, Date fechaFin);
	List<Baja> buscarPorTipoStatusPersonaEntreFechas(Integer estatus, Integer idPersona, Date fechaInicio, Date fechaFin);
	List<Baja> buscarPorTipoStatusEntreFechas(Integer estatus, Date fechaInicio, Date fechaFin);
