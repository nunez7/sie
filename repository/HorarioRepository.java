...
public interface HorarioRepository extends CrudRepository<Horario, Integer>{
	...
	List<Horario> findAllByHoraInicioAndDiaAndGrupoActivoTrue(@Param("horaInicio") String horaInicio, @Param("dia") Integer dia, @Param("grupo") Integer grupo);
	...
	List<Horario> findAllByHoraInicioAndDiaAndProfesorAndPeriodo(@Param("horaInicio") String horaInicio, @Param("dia") Integer dia,
