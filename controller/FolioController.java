...
public class FolioController {
	...
	public String recibopago(Model model, HttpSession session) {
		...
		String folio = String.valueOf(session.getAttribute("folio"));
		...
		if (folio != null) {
			...
			// se comprara si el estado de recibo esta activo o cancelado, en caso de ser
			// activo se obtiene el importe total, caso contrario se deja como 0.0 el
			// importe
