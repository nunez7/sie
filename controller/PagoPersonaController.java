...
public class PagoPersonaController {
	...
	public String calificacionesAlumno(@PathVariable("alumno") Integer cveAlumno, @PathVariable("grupo") Integer grupo, Model model,
		...
		System.err.println("alumno: "+alumno.getId());
		...
		System.err.println("calificaciones: " + calificaciones.size());
	...
	public String generarAdeudo(@RequestBody Map<String, String> obj, HttpSession session) throws ParseException {
		...
		System.err.println("nuevo folio generado: "+folio);
		...
		for (String string : keyList) {
			...
			if(clave.equals("on")) {
				System.err.println("numero de adeudo: "+string);
				...
				if (pagoExiste.getPagoCuatrimestre() != null) {
					AlumnoGrupo alumnoG = alGrService.buscarPorId(pagoExiste.getPagoCuatrimestre().getId());
